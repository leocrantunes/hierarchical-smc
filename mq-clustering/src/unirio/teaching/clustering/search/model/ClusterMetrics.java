...
public class ClusterMetrics
{
	 ...
	 */
	public void makeMovement(int module, int toCluster)
	{
		...
		int[] metrics = calculateMovementMetrics(module, toCluster);
	 ...
	 */
	public double calculateMovementDelta(int module, int toCluster)
	{
		int fromCluster = solution[module];
	 ...
	 */
	private int[] calculateMovementMetrics(int module, int toCluster)
	{
		int fromCluster = solution[module];
