...
<Workset version="11">
  <WorksetName>junit-jupiter-params-5.10.1</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/repos/junit5-r5.10.1/junit-jupiter-params/build/libs/junit-jupiter-params-5.10.1.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
  ...
  <IgnoreFilters>
    ...
    <PatternFilter active="yes" exclude="no">kotlin.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">com.googlecode.*</PatternFilter>
  </IgnoreFilters>
  <Architecture>
