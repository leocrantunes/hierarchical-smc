...
<Workset version="11">
  <WorksetName>mockito-5.7.0</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/repos/mockito-5.7.0/build/tmp/jar/mockito-core-0.0.1-SNAPSHOT.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
