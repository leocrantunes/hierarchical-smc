...
<Workset version="11">
  <WorksetName>log4j-iostreams-2.21.1</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/repos/logging-log4j2-rel-2.21.1/log4j-iostreams/target/log4j-iostreams-2.21.1.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
  ...
  <IgnoreFilters>
    ...
    <PatternFilter active="yes" exclude="no">org.apache.logging.log4j.LoggingException</PatternFilter>
