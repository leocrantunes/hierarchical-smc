...
<Workset version="11">
  <WorksetName>moquette-0.19</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/github/moquette/distribution/target/lib/moquette-broker-0.19-SNAPSHOT.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
  ...
  <IgnoreFilters>
    ...
    <PatternFilter active="yes" exclude="no">org.omg.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.w3c.dom.*</PatternFilter>
    <PatternFilter active="yes" exclude="yes">io.moquette.*</PatternFilter>
