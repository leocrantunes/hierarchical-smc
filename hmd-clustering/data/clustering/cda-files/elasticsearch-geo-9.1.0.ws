...
<Workset version="11">
  <WorksetName>elasticsearch-geo-9.1.0</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/github/elasticsearch/build/distribution/local/elasticsearch-9.1.0-SNAPSHOT/lib/elasticsearch-geo-9.1.0-SNAPSHOT.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
  ...
  <IgnoreFilters>
    ...
    <PatternFilter active="yes" exclude="no">org.omg.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.w3c.dom.*</PatternFilter>
    <PatternFilter active="yes" exclude="yes">org.elasticsearch.geometry.*</PatternFilter>
