...
<Workset version="11">
  <WorksetName>junit-platform-launcher-1.10.1</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/repos/junit5-r5.10.1/junit-platform-launcher/build/libs/junit-platform-launcher-1.10.1.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
  ...
  <IgnoreFilters>
    ...
    <PatternFilter active="yes" exclude="no">org.junit.platform.engine.*</PatternFilter>
  </IgnoreFilters>
  <Architecture>
