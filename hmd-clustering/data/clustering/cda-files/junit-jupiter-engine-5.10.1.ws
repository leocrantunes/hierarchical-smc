...
<Workset version="11">
  <WorksetName>junit-jupiter-engine-5.10.1</WorksetName>
  ...
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/repos/junit5-r5.10.1/junit-jupiter-engine/build/libs/junit-jupiter-engine-5.10.1.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
  ...
  <IgnoreFilters>
    ...
    <PatternFilter active="yes" exclude="no">org.omg.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.w3c.dom.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.apiguardian.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.junit.platform.commons.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.junit.jupiter.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.junit.platform.*</PatternFilter>
    <PatternFilter active="yes" exclude="no">org.opentest4j.*</PatternFilter>
  </IgnoreFilters>
  <Architecture>
