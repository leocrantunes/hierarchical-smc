...
<Workset version="11">
  <WorksetName>apm-network-9.6.0</WorksetName>
  <Options analyze-spring-beans="no" auto-reload="no" calculate-hashes="no" include-resources="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/leo/repos/apache-skywalking-apm-9.6.0/apm-protocol/apm-network/target/apm-network-9.6.0.jar</ClasspathPart>
  </Classpath>
  <ViewFilters>
